<?php  return array (
  ...
  array (
    ...
    'cacheable' => 1,
    'createdby' => 1,
    'createdon' => 1524333386,
    'editedby' => 0,
    'editedon' => 0,
    'deleted' => 0,
    'deletedon' => 0,
    'deletedby' => 0,
    'publishedon' => 1524333386,
    'publishedby' => 1,
    'menutitle' => '',
    'donthit' => 0,
    'privateweb' => 0,
			...
			<div class="menu_block">
				...
				<div class="container clearfix">
					...
					<div class="pull-right">
					    ...
					    <ul  class=""><li class="first scroll_btn1"><a href="/" >Главная</a></li><li  class="scroll_btn1 sub-menu"><a href="uslugi/" >Услуги</a><ul  class="laval-menu"><li  class="first scroll_btn2 sub-menu"><a href="uslugi/audit-i-analitiki/" >Аудит и аналитики</a><ul  class="laval-menu"><li class="first scroll_btn3"><a href="uslugi/audit-i-analitiki/texnicheskij-audit.html" >Технический аудит</a></li><li class="scroll_btn3"><a href="uslugi/audit-i-analitiki/marketingovyij-audit.html" >Маркетинговый аудит</a></li><li class="scroll_btn3"><a href="uslugi/audit-i-analitiki/poiskovyij-seo-audit.html" >Поисковый  seo аудит</a></li><li class="scroll_btn3"><a href="uslugi/audit-i-analitiki/yuzabiliti-audit.html" >Юзабилити  аудит</a></li></ul></li><li  class="scroll_btn2 sub-menu"><a href="uslugi/prodvizhenie-sajtov/" >Продвижение сайтов</a><ul  class="laval-menu"><li class="first scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/seo-optimizacziya.html" >SEO оптимизация</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/kontekstnaya-reklama.html" >Контекстная реклама</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/smm,-smo,-sem.html" >SMM, SMO, SEM</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/e-mail-marketing.html" >e-mail маркетинг</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/serm.html" >SERM</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/partnerskij-marketing.html" >Партнерский маркетинг</a></li><li class="scroll_btn3"><a href="uslugi/prodvizhenie-sajtov/kontekst-marketing.html" >Контекст маркетинг</a></li></ul></li><li  class="scroll_btn2 sub-menu"><a href="uslugi/razrabotka/" >Разработка</a><ul  class="laval-menu"><li class="first scroll_btn3"><a href="uslugi/razrabotka/razrabotka-sajta.html" >Разработка сайта</a></li></ul></li><li class="scroll_btn2"><a href="uslugi/dizajn.html" >Дизайн</a></li><li class="scroll_btn2"><a href="uslugi/fotografiya.html" >Фотография</a></li></ul></li><li class="scroll_btn1"><a href="agentstvo.html" >Агентство</a></li><li class="scroll_btn1"><a href="kejsyi/" >Кейсы</a></li><li class="scroll_btn1"><a href="blog/" >Блог</a></li><li class="scroll_btn1 active"><a href="kontaktyi.html" >Контакты</a></li></ul>
						</nav>
					</div><!-- //MENU -->
				</div><!-- //MENU BLOCK -->
			</div><!-- //CONTAINER -->
    ...
    <div class="container">
        <div class="row">
            ...
            <form action="">
                <div class="txt">
                    <p>
                        Заполните заявку и наш менеджер свяжется с вами в течении 5 минут в рабочее время
                    </p>
                </div>
                <fieldset>
                    <div class="seporate">
                        <label for="nameFooter">Ваше имя</label>
                        <input class="first" type="text" id="nameFooter" name="nameFooter">
                    </div>
                    <div class="seporate">
                        <label class="last" for="phoneFooter">Контактный телефон</label>
                        <input class="last" type="text" id="phoneFooter" name="phoneFooter">
                    </div>
                    
                </fieldset>
                <fieldset>
                    <div class="seporate">
                        <label for="emailFooter">Электронная почта</label>
                        <input class="first" type="text" id="emailFooter" name="emailFooter">
                    </div>
                    <div class="seporate">
                        <label class="last" for="siteFooter">Сайт компании</label>
                        <input class="last" type="text" id="siteFooter" name="siteFooter">
                    </div>
                </fieldset>
                <fieldset>
                    <label for="messageFooter">Ваш вопрос специалистам</label>
                    <textarea name="messageFooter" id="messageFooter" cols="30" rows="10"></textarea>
                </fieldset>
                <button type="submit">Отправить заявку</button>
                <div class="offer">
                    <p>Отправляя форму, вы соглашаетесь на обработку персональных данных, защищенных политикой конфиденциальности и обрабатываемых для выполнения вашей задачи</p>
                </div>
            </form>
        </div>
    </div>   
...
&tplParentRow=`@INLINE <li [[+classes]]><a href="[[+link]]" [[+attributes]]>[[+menutitle]]</a>[[+wrapper]]</li>`
    ...
    '[[migxResourceMediaPath? &pathTpl=`assets/site/images/clients/{id}/` &createFolder=`1`]]' => 'assets/site/images/clients/11/',
    ...
    <div class="work_item">
        ...
        <div class="work_description">
            <div class="work_descr_cont">
                <a href="http://quo-group.ru/kejsyi/kejs-pervyij.html" >Кейс первый</a>
...
<div class="item">
    <div class="work_item">
        <div class="work_img">
            <img src="/assets/site/images/works/7.jpg" alt="Кейс второй" />
            <a class="zoom" href="/assets/site/images/works/7.jpg" rel="prettyPhoto[portfolio1]" ></a>
        </div>
        <div class="work_description">
            <div class="work_descr_cont">
                <a href="http://quo-group.ru/kejsyi/kejs-vtoroj.html" >Кейс второй</a>
                <span>24 Апрель, 2018</span>
            </div>
        </div>
    </div>
...
<div class="item">
    <div class="work_item">
        <div class="work_img">
            <img src="/assets/site/images/works/3_2.jpg" alt="Кейс третий" />
            <a class="zoom" href="/assets/site/images/works/3_2.jpg" rel="prettyPhoto[portfolio1]" ></a>
        </div>
        <div class="work_description">
            <div class="work_descr_cont">
                <a href="http://quo-group.ru/kejsyi/kejs-tretij.html" >Кейс третий</a>
                <span>24 Апрель, 2018</span>
            </div>
        </div>
    </div>
...
<div class="item">
    <div class="work_item">
        <div class="work_img">
            <img src="/assets/site/images/works/5.jpg" alt="кейс тест" />
